...
class TestBetweennessCentrality:
    ...
    def test_P3_normalized(self):
        ...
        G = LazyGraph.from_graph_edges(nx.path_graph(3))
    ...
    def test_krackhardt_kite_graph(self):
        ...
        G = LazyGraph.from_graph_edges(nx.krackhardt_kite_graph())
        b_answer = {
            0: 1.667,
            1: 1.667,
            2: 0.000,
...
class TestWeightedEdgeBetweennessCentrality:
    ...
    def test_balanced_tree(self):
        """Edge betweenness centrality: balanced tree"""
        G = LazyGraph.from_graph_edges(nx.balanced_tree(r=2, h=2))
        b = nx.edge_betweenness_centrality(G, weight="weight", normalized=False)
        b_answer = {(0, 1): 12, (0, 2): 12, (1, 3): 6, (1, 4): 6, (2, 5): 6, (2, 6): 6}
        for n in sorted(G.edges()):
            assert b[n] == pytest.approx(b_answer[n], abs=1e-7)
